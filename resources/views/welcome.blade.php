    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                @auth
                    ...
                    <a href="{{ auth()->user()->getRedirectRoute() }}"
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                ...
                <svg viewBox="0 0 65 65" xmlns="http://www.w3.org/2000/svg" class="h-16 w-auto">
                    <image href="https://i.ibb.co/Q9QJ90R/rentify-logdoszsw.png" width="65" height="65" />
                </svg>
            </div>
