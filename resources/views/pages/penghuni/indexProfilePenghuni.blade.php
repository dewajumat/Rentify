...
@section('content')
    ...
    <div class="container">
        <div class="container mt-2">
            <div class="card bg-light mb-3 text-left mx-auto " style="width: 35rem;">
                    ...
                    <div class="col">
                        ...
                        <div class="mb-2">
                            ...
                            <input class="form-control" id="name" name="name" type="text" placeholder="Nama"
                                value="@isset($dataPenghuni->name){{ $dataPenghuni->name }}@endisset" disabled
                                required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control" id="email" name="email" type="text" placeholder="Email"
                                value="@isset($dataPenghuni->email){{ $dataPenghuni->email }}@endisset" disabled
                                requireds>
                        </div>
                        <div class="d-grid text-center">
                            <a href="{{ route('rUptdProfilePenghuni', ['id' => Auth::user()->id]) }}">
